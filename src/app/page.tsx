      ...
      <div className={utilStyles.thickMargin}>
        ...
        <div className={styles.pageContainer}>
          <section className={styles.intro}>
            <h1>
              Hi, I'm Emily Liew, a junior currently studying computer science
              at Georgia Tech to create software that will positively impact
              others' lives.
            </h1>
            <p style={{ fontStyle: "italic" }}>
              I am currently seeking a software engineering internship for
              Summer 2024. Email me with any opportunities or questions! →{" "}
              <a
                href="mailto: eliew3@gatech.edu"
